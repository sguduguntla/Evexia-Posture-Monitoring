...
<title>Blog | Dale | Creative Bootstrap HTML5 Theme</title>
            ...
            <div class="container">
            	<div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="anim fadeInDown" data-wow-delay=".32s">Check out our badass posts.</p>
        	...
        	<div class="row">
            	...
            	<div class="col-lg-9">	
                   	...
                   	<div class="blog anim fadeInLeft">
                        <span class="image">
                            <a href="single.html" id="desc" data-icon="fa-link">
                                <img src="http://placehold.it/870x390/f8c2c5/ffffff" alt="Blog Sample Image" />
                            </a>
                        </span><!-- .image -->
                        ...
                        <span class="title-desc">
                            <h3>Our new custom website design packages.</h3>
                            <ul class="meta">
                                <li><a href="single.html"><i class="fa fa-user"></i>SupremeGeneral</a></li>
                        ...
                        <p>
                            Nam ipsum nunc, egestas eu nisl non, auctor consequat leo. Phasellus et neque sit amet sapien ultric vitae orci. 
                            Donec pretium, quam id porta eleifend, justo erat luctus felis, eget molestie ligula nisl vel sap aliquet ultrices sem, sit
                            amet ultrices risus ullamcorper eu. Nullam ac bibendum dui. Etiam venenatis In lobortis velit vel fermentum 
                            placerat. Nulla nec tincidunt libero.
                        </p>
                	...
                	<div class="blog anim fadeInLeft">
                       <span class="image">
                        ...
                        <span class="title-desc">
                            <h3>Pictures so awesome, you'll download them all.</h3>
                            <ul class="meta">
                                <li><a href="single.html"><i class="fa fa-user"></i>SupremeGeneral</a></li>
                                <li><a href="single.html"><i class="fa fa-comment"></i>23</a></li>
                                <li><a href="single.html"><i class="fa fa-heart"></i>313</a></li>
                                <li><a href="single.html"><i class="fa fa-external-link"></i>3</a></li>
                            </ul><!-- .meta -->
                        </span><!-- .title-desc -->
                        ...
                        <a class="btn btn-sm btn-primary icon" data-wow-delay=".45s" role="button"><i class="fa fa-long-arrow-right"></i>Read More</a>
                    ...
                    <div class="blog anim fadeInLeft">
                       <span class="image">
                        ...
                        <span class="title-desc">
                            <h3>Our new custom website design packages.</h3>
                            <ul class="meta">
                                <li><a href="single.html"><i class="fa fa-user"></i>MuffinBasket221</a></li>
                                <li><a href="single.html"><i class="fa fa-comment"></i>43</a></li>
                                <li><a href="single.html"><i class="fa fa-heart"></i>3</a></li>
                                <li><a href="single.html"><i class="fa fa-external-link"></i>4</a></li>
                            </ul><!-- .meta -->
                        </span><!-- .title-desc -->
                ...
                <div class="col-lg-3 sidebar">
                    ...
                    <h4 class="anim fadeInRight">
                    	Recent Comments<i class="fa fa-comment"></i>
                    </h4>
                    ...
                    <div class="anim fadeInRight">
                        <ul id="carousel" class="comments-wrapper">
                           ...
                           <li>
                                <ul class="comments">
                                    <li>
                                        Suspendisse nec risus lorem. Morbi dapib.
                                        <a href="single.html">- Username</a>
                                    </li>
                                    <li>
                                        Suspendisse nec risus lorem. Morbi dapib.
